...
namespace SuperScrollView
{
    ...
    public class SpinDatePickerDemoScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            mLoopListViewMonth.mOnSnapTargetChanged = OnMonthSnapTargetChanged;
            mLoopListViewDay.mOnSnapTargetChanged = OnDaySnapTargetChanged;
            mLoopListViewHour.mOnSnapTargetChanged = OnHourSnapTargetChanged;
